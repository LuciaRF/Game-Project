...
IL2CPP_EXTERN_C String_t* _stringLiteral3E2C43C9C00689089D66DA8A5F55D4B2B0CCF6E6;
...
IL2CPP_EXTERN_C String_t* _stringLiteralB6003B9393010806793DF0D6EEFFBE8D8B38D660;
...
struct CameraInteraction_t94C37E9A31BFAE008F0374ABC84A538C5471894F  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___positionPointOfInterest_9;
	// UnityEngine.Vector3 CameraInteraction::positionActualPlayer
	Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___positionActualPlayer_10;
};
...
struct MenuInteractor_t6A394B73B41A019759906734B8374EEB4A587C14  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	// UnityEngine.Vector3 MenuInteractor::positionPointOfInterest
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CameraInteraction_Start_m1A5EF44DE14F811EC31553A59B596CF63165C1DA (CameraInteraction_t94C37E9A31BFAE008F0374ABC84A538C5471894F* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		L_5 = Transform_Find_m3087032B0E1C5B96A2D2C27020BAEAE2DA08F932(L_4, _stringLiteral570059DAA6BA36583F759B87A49DCE91093D6090, NULL);
		__this->____jugador_7 = L_5;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____jugador_7), (void*)L_5);
		...
		__this->___positionActualPlayer_10 = L_7;
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CameraInteraction_Update_m4A4137525002A39A37908A8648A5CAA5CA9AB2EB (CameraInteraction_t94C37E9A31BFAE008F0374ABC84A538C5471894F* __this, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral3E2C43C9C00689089D66DA8A5F55D4B2B0CCF6E6);
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral7E41462DEE53D1BD614627C30B26FC53174D292A);
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteralB6003B9393010806793DF0D6EEFFBE8D8B38D660);
	...
	memset((&V_0), 0, sizeof(V_0));
	{
		...
		// if (Physics.Raycast(positionActualPlayer, _jugador.forward, out hit, rayDistance,layerInteractable))
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_7 = __this->___positionActualPlayer_10;
		...
		float L_10 = __this->___rayDistance_5;
		LayerMask_t97CB6BDADEDC3D6423C7BCFEA7F86DA2EC6241DB L_11 = __this->___layerInteractable_6;
		int32_t L_12;
		L_12 = LayerMask_op_Implicit_m7F5A5B9D079281AC445ED39DEE1FCFA9D795810D(L_11, NULL);
		bool L_13;
		L_13 = Physics_Raycast_m56120FFEF0D4F0A44CCA505B5C946E6FB8742F12(L_7, L_9, (&V_0), L_10, L_12, NULL);
		if (!L_13)
		{
			goto IL_014d;
		}
	}
	{
		...
		// Debug.Log("Posicion actual del jugador");
		Debug_Log_m87A9A3C761FF5C43ED8A53B16190A53D08F818BB(_stringLiteralB6003B9393010806793DF0D6EEFFBE8D8B38D660, NULL);
		// Debug.Log(positionActualPlayer);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_16 = __this->___positionActualPlayer_10;
		...
		__this->___positionPointOfInterest_9 = L_19;
		// Debug.Log("Posicion del interactable");
		Debug_Log_m87A9A3C761FF5C43ED8A53B16190A53D08F818BB(_stringLiteral3E2C43C9C00689089D66DA8A5F55D4B2B0CCF6E6, NULL);
		// Debug.Log(positionPointOfInterest);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_20 = __this->___positionPointOfInterest_9;
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_23 = (&__this->___positionActualPlayer_10);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_24 = (&__this->___positionPointOfInterest_9);
		float L_25 = L_24->___x_2;
		L_23->___x_2 = L_25;
		// positionActualPlayer.z = positionPointOfInterest.z;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_26 = (&__this->___positionActualPlayer_10);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_27 = (&__this->___positionPointOfInterest_9);
		...
		__this->___timeMovementPlayer_8 = ((float)il2cpp_codegen_add(L_29, L_30));
		// if (timeMovement >= timeMovementPlayer)
		float L_31 = __this->___timeMovement_4;
		float L_32 = __this->___timeMovementPlayer_8;
	...
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_33 = __this->____jugador_7;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_34 = __this->___positionActualPlayer_10;
		NullCheck(L_33);
		...
		// Debug.Log(positionActualPlayer);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_35 = __this->___positionActualPlayer_10;
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_38 = __this->____jugador_7;
		NullCheck(L_38);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MenuInteractor_Update_m1A65A6D1FEC1157B6DF4C2318938E6F5A383BE5D (MenuInteractor_t6A394B73B41A019759906734B8374EEB4A587C14* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		// timeMovementPlayer += Time.deltaTime;
		float L_16 = __this->___timeMovementPlayer_9;
		float L_17;
		L_17 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		__this->___timeMovementPlayer_9 = ((float)il2cpp_codegen_add(L_16, L_17));
		// if (timeMovement >= timeMovementPlayer)
		float L_18 = __this->___timeMovement_4;
		float L_19 = __this->___timeMovementPlayer_9;
...
IL_00a6:
	{
		// if (Physics.Raycast(_jugador.position, _jugador.forward, out hit, rayDistance,layerExit))
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_20 = __this->____jugador_8;
		NullCheck(L_20);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_21;
		L_21 = Transform_get_position_m69CD5FA214FDAE7BB701552943674846C220FDE1(L_20, NULL);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_22 = __this->____jugador_8;
		NullCheck(L_22);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_23;
		L_23 = Transform_get_forward_mFCFACF7165FDAB21E80E384C494DF278386CEE2F(L_22, NULL);
		float L_24 = __this->___rayDistance_5;
		LayerMask_t97CB6BDADEDC3D6423C7BCFEA7F86DA2EC6241DB L_25 = __this->___layerExit_7;
		int32_t L_26;
		L_26 = LayerMask_op_Implicit_m7F5A5B9D079281AC445ED39DEE1FCFA9D795810D(L_25, NULL);
		bool L_27;
		L_27 = Physics_Raycast_m56120FFEF0D4F0A44CCA505B5C946E6FB8742F12(L_21, L_23, (&V_0), L_24, L_26, NULL);
		if (!L_27)
		{
			goto IL_0115;
		}
	}
	{
		...
		__this->___positionPointOfInterest_10 = L_28;
		// timeMovementPlayer += Time.deltaTime;
		float L_29 = __this->___timeMovementPlayer_9;
		float L_30;
		L_30 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		__this->___timeMovementPlayer_9 = ((float)il2cpp_codegen_add(L_29, L_30));
		// if (timeMovement >= timeMovementPlayer)
		float L_31 = __this->___timeMovement_4;
		float L_32 = __this->___timeMovementPlayer_9;
		if ((!(((float)L_31) >= ((float)L_32))))
		{
			goto IL_0120;
		}
...
{
	{
		// public float timeMovement = 3.0f;
		__this->___timeMovement_4 = (3.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
